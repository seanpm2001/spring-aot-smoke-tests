...
public record SmokeTest(String name, String group, String path, boolean tests, boolean appTests,
		SmokeTest.SlackNotifications slackNotifications) implements Serializable {
	...
	public record SlackNotifications(String channel, boolean onSuccess, boolean onFailure) implements Serializable {
